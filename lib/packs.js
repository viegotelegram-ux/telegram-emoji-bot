...
const PACKS = [
  {
    id: "crossey-classic",
    name: "Crossey (Classic)",
    description: "8 animated emoji from the Crossey pack — no snow effect. [Provisional selection — tell me which 8 files you actually want here and I'll swap them in.]",
    priceCents: 0,
    kind: "tgs",
    shapes: ["classic-1", "classic-2", "classic-3", "classic-4", "classic-5", "classic-6", "classic-7", "classic-8"],
  },
  {
    id: "crossey-snow",
    name: "Crossey (Snow)",
    description: "8 animated emoji from the Crossey pack — with the added snow animation. [Provisional selection — tell me which 8 files you actually want here and I'll swap them in.]",
    priceCents: 0,
    kind: "tgs",
    shapes: ["snow-1", "snow-2", "snow-3", "snow-4", "snow-5", "snow-6", "snow-7", "snow-8"],
  },
  {
    id: "solid-shapes",
    name: "Solid Shapes",
