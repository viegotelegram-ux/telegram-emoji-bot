 ...
 * @param {Array<{buffer: Buffer, filename: string}>} opts.stickers - up to 50
...
async function createCustomEmojiStickerSet({ botToken, userId, name, title, stickers }) {
  ...
  if (stickers.length > 50) throw new Error("Telegram allows at most 50 stickers in the initial createNewStickerSet call");
...
module.exports = { buildStickerSetName, createCustomEmojiStickerSet, addEmojiPackLink };
